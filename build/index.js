...
function _default({
  ...
  {
    match: and(hasOnlyDefaultMember, isAbsoluteModule, not(isTypeImport)),
    sort: member(unicode)
  }, // import UpperThing, { innerThing } from 'thing';
  // import lowerThing, { innerThing } from 'thing';
  {
    match: and(hasDefaultMember, hasNamedMembers, isAbsoluteModule, not(isTypeImport)),
    sort: member(unicode),
    sortNamedMembers: name(unicode)
  }, // import * as Thing from 'thing';
  {
    match: and(hasOnlyNamespaceMember, isAbsoluteModule, not(isTypeImport)),
    sort: member(unicode)
  }, // import { innerThing1, innerThing2 } from 'thing';
  {
    match: and(hasOnlyNamedMembers, isAbsoluteModule, not(isTypeImport)),
    sort: moduleName(unicode),
    sortNamedMembers: name(unicode)
  ...
  {
    match: and(hasOnlyDefaultMember, isLocalModule, not(isTypeImport)),
    sort: member(unicode)
  }, // import UpperThing, { innerThing } from './path';
  // import lowerThing, { innerThing } from './path';
  {
    match: and(hasDefaultMember, hasNamedMembers, isLocalModule, not(isTypeImport)),
    sort: member(unicode),
    sortNamedMembers: name(unicode)
  }, // import * as Thing from './path';
  {
    match: and(hasOnlyNamespaceMember, isLocalModule, not(isTypeImport)),
    sort: member(unicode)
  }, // import { innerThing1, innerThing2 } from './path';
  {
    match: and(hasOnlyNamedMembers, isLocalModule, not(isTypeImport)),
    sort: [dotSegmentCount, moduleName(unicode)],
    sortNamedMembers: name(unicode)
  }, // import type { ... } from './path';
  {
    match: and(isTypeImport, isLocalModule),
    sort: [dotSegmentCount, moduleName(unicode)],
    sortNamedMembers: name(unicode)
  }, {
    separator: true
  ...
  // import lowerThing from '../../path';
  {
    match: and(hasOnlyDefaultMember, isRelativeModule, not(isTypeImport)),
    sort: member(unicode)
  }, // import UpperThing, { innerThing } from '../../path';
  // import lowerThing, { innerThing } from '../../path';
  {
    match: and(hasDefaultMember, hasNamedMembers, isRelativeModule, not(isTypeImport)),
    sort: member(unicode),
    sortNamedMembers: name(unicode)
  }, // import * as Thing from '../../path';
  {
    match: and(hasOnlyNamespaceMember, isRelativeModule, not(isTypeImport)),
    sort: member(unicode)
  }, // import { innerThing1, innerThing2 } from '../../path';
  {
    match: and(hasOnlyNamedMembers, isRelativeModule, not(isTypeImport)),
    sort: [dotSegmentCount, moduleName(unicode)],
    sortNamedMembers: name(unicode)
  }, // import type { ... } from '../../path';
  {
